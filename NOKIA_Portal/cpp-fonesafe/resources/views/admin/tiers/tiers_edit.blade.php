        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <form class="form-horizontal" action="{{ route('tiers.update', $tier->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row{{ $errors->has('tier') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="tier" id="tier" class="form-control" value="{{ $tier->tier }}" placeholder="ex-T1">
                                    </div>
                                </div>
                                @if ($errors->has('tier'))
                        ...
                        <div class="row{{ $errors->has('price_range_start') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="price_range_start" id="price_range_start" value="{{ $tier->price_range_start }}" class="form-control" placeholder="ex-5000">
                                    </div>
                                </div>
                        ...
                        <div class="row{{ $errors->has('price_range_end') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="price_range_end" id="price_range_end" class="form-control" value="{{ $tier->price_range_end }}" placeholder="ex-10000">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="demo-checkbox">
                                        <select name="service_type" class="form-control selectpicker" data-live-search="true" id="service_type">
                                            ...
                                            <option value="Accidental Screen Damage" {{$tier->service_type == 'Accidental Screen Damage' ? 'selected="selected"' : ''}}>Accidental Screen Damage</option>
                                            <option value="1 Year Extended Warranty" {{$tier->service_type == '1 Year Extended Warranty' ? 'selected="selected"' : ''}}>1 Year Extended Warranty</option>
                                            <option value="Both Service" {{$tier->service_type == 'Both Service' ? 'selected="selected"' : ''}}>Both Service</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row{{ $errors->has('mrp') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="mrp" id="mrp" class="form-control" value="{{ $tier->mrp }}" placeholder="ex-599">
                                    </div>
                                </div>
                                @if ($errors->has('mrp'))
                        ...
                        <div class="row{{ $errors->has('commission') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="commission" id="commission" class="form-control" value="{{ $tier->commission }}" placeholder="ex-125">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <select class="form-control selectpicker" name="status" id="status">
                                            <option value="1" {{$tier->status == 1 ? 'selected="selected"' : ''}}>Available</option>
                                            <option value="2" {{$tier->status == 2 ? 'selected="selected"' : ''}}>Disable</option>
                                        </select>
                                    </div>
                                </div>
                            </div>

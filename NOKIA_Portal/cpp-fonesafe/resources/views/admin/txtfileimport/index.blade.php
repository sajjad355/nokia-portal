    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <div class="row ">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <a href="{{ route('download.index') }}"><button type="button" class="btn bg-green waves-effect">Download Sample</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="body">
                    <form class="form-horizontal" action="{{ route('txtimport.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('txtimport.destroy',$data['id']) }}" method="POST">

                                            <a class="btn btn-defauld" href="{{ route('txtimport.show', $data['id']) }}"><i class="fa fa-bars" aria-hidden="true" title="view"></i></a>

                                            &nbsp;&nbsp; <a class="btn btn-primary" href="{{ route('txtimport.edit', $data['id']) }}"><i class="fa fa-pencil-square-o" aria-hidden="true" title="edit"></i></a>

        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <form class="form-horizontal" action="{{ route('outlet.store')}}" method="POST">
                        @csrf
                        <div class="row{{ $errors->has('store_code') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div>
                                        <input type="text" name="store_code" id="store_code" value="{{ $store_code }}" class="form-control" readonly>
                                    </div>
                                </div>
                        ...
                        <div class="row{{ $errors->has('store_name') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="store_name" id="store_name" value="{{ Request::old('store_name') ?: '' }}" class="form-control" placeholder="Enter store name">
                                    </div>
                                </div>
                        ...
                        <div class="row{{ $errors->has('address') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="address" id="address" class="form-control" value="{{ Request::old('address') ?: '' }}" placeholder="Enter store address">
                                    </div>
                                </div>
                        ...
                        <div class="row{{ $errors->has('contact_details') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="contact_details" id="contact_details" class="form-control" value="{{ Request::old('contact_details') ?: '' }}" placeholder="Please enter 11 digit phone number">
                                    </div>
                                </div>

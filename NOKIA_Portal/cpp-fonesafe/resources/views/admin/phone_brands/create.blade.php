        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <form class="form-horizontal" action="{{ route('phone_brands.store')}}" method="POST">
                        @csrf
                        ...
                        <div class="row{{ $errors->has('brand_name') ? ' has-error' : '' }} clearfix">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="brand_name" id="brand_name" class="form-control" value="{{ Request::old('brand_name') ?: '' }}" placeholder="ex-Apple">
                                    </div>
                                </div>
